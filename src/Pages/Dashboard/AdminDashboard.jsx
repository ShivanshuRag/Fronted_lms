...
import { getStatsData } from "../../Redux/Slices/StaticsSlice.js";
...
function AdminDashboard() {
    ...
    const { allUserCount, subscribedUser } = useSelector((state) => state.static);
                                ...
                                {myCourses?.map((course, idx) => {
                                    return (
                                        <tr key={course._id}>
                                            ...
                                            <td className="max-w-28 overflow-auto text-ellipsis whitespace-nowrap">
                                                <textarea
