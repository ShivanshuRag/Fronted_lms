...
function Checkout(){
    ...
    async function handleSubscription(e){
        ...
        if(!razorpaykey || !subscription_id ){
            toast.error(" something went wrong in razorpay or subscripationId");
            return
        }
        ...
        <HomeLayout>
          ...
          className="min-h-[90vh] flex items-center justify-center text-white">
            ...
            <div className=" w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
             <h1 className="bg-yellow-500 absolute top-0 w-full text-center py-4 text-2xl font-bold rounded-t10lg rounded-tr-lg">Subscription Bundle</h1>
